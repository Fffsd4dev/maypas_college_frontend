...
export default function MobileMenu({handleMobileMenu}) {
    ...
    const isActive2 = (href) => router.pathname === href;
    ...
    return (
        <>
            <ul className="navigation">
                <li onClick={handleMobileMenu} className={isActive2("/") ? "active sub-menu" : "sub-menu"}><Link href="/">Home</Link>
                ...
                <li onClick={handleMobileMenu} className={isActive2("/courses") ? "active sub-menu" : "sub-menu"}><Link href="/courses">Courses</Link>
                ...
                <li onClick={handleMobileMenu} className={isActive2("/about-us") ? "active sub-menu" : "sub-menu"}><Link href="/about-us">About Us</Link>
                ...
                <li onClick={handleMobileMenu} className={isActive2("/blog") ? "active sub-menu" : "sub-menu"}><Link href="/blog">Blog</Link>
                    {/* <ul className="sub-menu" style={{ display: `${isActive.key == 5 ? "block" : "none"}` }}>
                      ...
                      <li onClick={handleMobileMenu} className={isActive2("/faq") ? "active sub-menu" : "sub-menu"}><Link href="/faq"> Frequently Asked Questions</Link></li>

                        ...
                        <div className="col-xl-6 col-lg-7">
                            <div className="about__content">
                                <div className="section__title">
                                    ...
                                    <h2 className="title tg-svg">Learn from <span className="position-relative"><span className="svg-icon" id="svg-3" data-svg-icon="assets/img/icons/title_shape.svg" />Instructors</span>
                                        Around the World</h2>
                                </div>
                                <p className="desc">MaypasCollege believes in providing high-quality education to students worldwide.
                                    Our experienced instructors are dedicated to delivering engaging and effective learning experiences through our online platform.
                                    These experts bring a wealth of knowledge and practical insights to help students achieve their academic and career goals.
                                    The learning prepares students to excel in their chosen fields and make a positive impact in their communities.
                                </p>

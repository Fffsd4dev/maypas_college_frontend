                    ...
                    <div className="row align-items-center justify-content-center">
                        <div className="col-xl-5 col-lg-8 col-md-10">
                            <div className="categories__title-wrap text-center text-xl-start">
                                ...
                                <p>Maypas College offers a wide range of online courses designed to meet the needs of learners at every level.
                                    Explore our diverse programmes and find the perfect fit for your educational journey.
                                    Our courses are crafted by industry experts to ensure you gain practical skills and knowledge that can be applied in real-world scenarios.

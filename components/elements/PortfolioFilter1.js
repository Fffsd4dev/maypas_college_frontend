...
export default function PortfolioFilter1() {
  ...
  useEffect(() => {
    ...
    fetchFeaturedCourses()
      .then((data) => {
        const arr = Array.isArray(data) ? data : data.data || [];
        console.log('Featured courses data:', arr); // Debug log
        setCourses(arr);
      })
      .catch((error) => {
          ...
          return (
            ...
            <div className="courses__item shine__animate-item" style={{ minHeight: '450px',  }} >
              <div className="courses__item-thumb">
                ...
                <Link href={`/course/${course.course_id}`} className="shine__animate-link">
                  <img
                    src={
                    ...
                    alt="img"
                                            style= {{ objectFit: 'cover', width: '370px', height: '260px' }}
              ...
              <div className="courses__item-content">
                ...
                <h5 className="title">
                  <Link href={`/course/${course.course_id}`} dangerouslySetInnerHTML={{ __html: course.title }} />
                </h5>
                <div className="courses__item-bottom">
                    <div className="">
                                        <Link href={`/course/${course.course_id}`} className="btn btn-sec">Learn More</Link>
                                    </div>

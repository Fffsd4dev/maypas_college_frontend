    ...
    return (
        <>
            <Layout 
                ...
                keywords="education, professional training, online courses, career development, MayPas College" breadcrumbTitle="Shop Details">
                            ...
                            <div className="col-lg-6">
                                <div className="shop-details-content">
                                    ...
                                    <div className="shop-details-qty">
                                        ...
                                        <Link href="/shop-details" className="cart-btn btn">Add To Cart</Link>
                                        <Link href="/shop-details" className="wishlist-btn"><i className="far fa-heart" /></Link>
                                    </div>

...
export default function AboutUs() {
    ...
    const sliderSettings = {
        dots: true,
        infinite: false,//set to true in the future
        speed: 500,
        slidesToShow: 3,
        slidesToScroll: 1,
        responsive: [
    ...
    return (
        ...
        <>
            <Layout 
                ...
                keywords="education, professional training, online courses, career development, MayPas College" breadcrumbTitle="About Us">
                <div>

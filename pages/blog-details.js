...
return (
    <>
        <Layout 
                ...
                keywords="education, professional training, online courses, career development, MayPas College" breadcrumbTitle="Blog Details">
                        ...
                        <div className="col-lg-8">
                            <div className="blog__standard-post blog__details-wrapper">
                                ...
                                <div className="blog__standard-content blog-details-content">
                                    <h3 className="title">When aeunkno printer took gallery of scrambled</h3>

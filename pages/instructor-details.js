    ...
    return (
        <>
            <Layout 
                ...
                keywords="education, professional training, online courses, career development, MayPas College" breadcrumbTitle="Instructor Details">
                <div>
                                            ...
                                            <div className="content-top">
                                                ...
                                                <div className="instructor-details-social">
                                                    <ul className="list-wrap">
                                                        ...
                                                        <li><Link href="#"><i className="fab fa-whatsapp" href="https://wa.me/447417473233" aria-label="Chat on WhatsApp" target="_blank"/></Link></li>
